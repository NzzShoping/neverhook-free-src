...
import ru.neverhook.feature.other.FastWorldLoad;
import ru.neverhook.feature.world.FreeCam;
import ru.neverhook.utils.font.FontUtil;
...
public class Minecraft implements IThreadListener, ISnooperInfo {
    ...
    public ru.neverhook.utils.font.FontRenderer fontRenderer;
    public ru.neverhook.utils.font.FontRenderer buttonFontRender;
    public ru.neverhook.utils.font.FontRenderer bigButtonFontRender;
    public ru.neverhook.utils.font.FontRenderer smallfontRenderer;
    public ru.neverhook.utils.font.FontRenderer clickguismall;
    public ru.neverhook.utils.font.FontRenderer verdana;
    public ru.neverhook.utils.font.FontRenderer robotoRegular;
    public ru.neverhook.utils.font.FontRenderer robotoLight;
    public ru.neverhook.utils.font.FontRenderer lato;
    public ru.neverhook.utils.font.FontRenderer arraylist;
    public ru.neverhook.utils.font.FontRenderer bigFontRender;
    public ru.neverhook.utils.font.FontRenderer arrayListQuick;
    public ru.neverhook.utils.font.FontRenderer notification;
    ...
    private void startGame() throws Exception {
        ...
        JOptionPane.showMessageDialog(null, "Хочешь стать ютубером чита и получить премиум версию бесплатно? Тогда снимай видео про неверхук, и напиши нам в группу! :)");
        ...
        this.arraylist = new ru.neverhook.utils.font.FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/comfortaa.ttf"), 19.0F, 0), true, true);
        this.bigFontRender = new ru.neverhook.utils.font.FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/sf-ui.ttf"), 48.0F, 0), true, true);
        this.clickguismall = new ru.neverhook.utils.font.FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/sf-ui.ttf"), 16.5F, 0), true, true);
        this.notification = new ru.neverhook.utils.font.FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/notification.ttf"), 45, 0), true, true);
        this.smallfontRenderer = new ru.neverhook.utils.font.FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/sf-ui.ttf"), 14.0F, 0), true, true);
        this.fontRenderer = new ru.neverhook.utils.font.FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/sf-ui.ttf"), 18, 0), true, true);
        this.buttonFontRender = new ru.neverhook.utils.font.FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/quicksand.ttf"), 28, 0), true, true);
        this.bigButtonFontRender = new ru.neverhook.utils.font.FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/quicksand.ttf"), 35, 0), true, true);
        this.arrayListQuick = new ru.neverhook.utils.font.FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/quicksand.ttf"), 20, 0), true, true);
        this.verdana = new ru.neverhook.utils.font.FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/verdana.ttf"), 19, 0), true, true);
        this.robotoLight = new ru.neverhook.utils.font.FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/roboto-light.ttf"), 19, 0), true, true);
        this.robotoRegular = new ru.neverhook.utils.font.FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/robotoregular.ttf"), 19, 0), true, true);
        this.lato = new ru.neverhook.utils.font.FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/lato.ttf"), 19, 0), true, true);
        ...
        this.renderItem = new RenderItem(this.renderEngine, modelManager, this.itemColors);
    ...
    private void func_193986_ar() {
        ...
        SearchTree<RecipeList> searchtree1 = new SearchTree<>((p_193990_0_) ->
                p_193990_0_.func_192711_b().stream().flatMap((p_193993_0_) -> p_193993_0_.getRecipeOutput().getTooltip(null, ITooltipFlag.TooltipFlags.NORMAL).stream()).map(TextFormatting::getTextWithoutFormattingCodes).map(String::trim).filter((p_193994_0_) -> !p_193994_0_.isEmpty()).collect(Collectors.toList()), (p_193991_0_) ->
                p_193991_0_.func_192711_b().stream().map((p_193992_0_) -> Item.REGISTRY.getNameForObject(p_193992_0_.getRecipeOutput().getItem())).collect(Collectors.toList()));
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("NeverHook " + Main.build);
    ...
    private void runGameLoop() throws IOException {
        ...
        while (getSystemTime() >= this.debugUpdateTime + 1000L) {
            debugFPS = (int) (this.fpsCounter * 1.1F);
    ...
    public void freeMemory() {
        ...
        try {
            if (!Main.instance.featureManager.getFeatureByClass(FastWorldLoad.class).getState()) {
                System.gc();
                this.loadWorld(null);
            }
    ...
    public void clickMouse() {
        ...
        if (this.leftClickCounter <= 0) {
            EventAttackClient mouseAttackEvent = new EventAttackClient(objectMouseOver.entityHit, true);
            ...
            if (this.objectMouseOver == null) {
                ...
                switch (this.objectMouseOver.typeOfHit) {
                    case ENTITY:
                        ...
                        if (!Main.instance.featureManager.getFeatureByClass(AntiBot.class).getState() && mode.equalsIgnoreCase("Need Hit"))
                            break;
    ...
    public void runTick() throws IOException {
        ...
        if (this.world != null) {
            ...
            if (!this.isGamePaused && Main.instance.featureManager.getFeatureByClass(FreeCam.class).getState()
                    && this.world != null) {
    ...
    public CrashReport addGraphicsAndWorldToCrashReport(CrashReport theCrash) {
        theCrash.getCategory().setDetail("Launched Version", () -> Minecraft.this.launchedVersion);
        theCrash.getCategory().setDetail("LWJGL", Sys::getVersion);
        theCrash.getCategory().setDetail("OpenGL", () -> GlStateManager.glGetString(7937) + " GL version " + GlStateManager.glGetString(7938) + ", " + GlStateManager.glGetString(7936));
        theCrash.getCategory().setDetail("GL Caps", OpenGlHelper::getLogText);
        theCrash.getCategory().setDetail("Using VBOs", () -> Minecraft.this.gameSettings.useVbo ? "Yes" : "No");
        theCrash.getCategory().setDetail("Is Modded", () -> {
        ...
        theCrash.getCategory().setDetail("Type", () -> "Client (map_client.txt)");
        theCrash.getCategory().setDetail("Resource Packs", () -> {
            StringBuilder stringbuilder = new StringBuilder();
        ...
        theCrash.getCategory().setDetail("Current Language", () -> Minecraft.this.mcLanguageManager.getCurrentLanguage().toString());
        theCrash.getCategory().setDetail("Profiler Position", () -> Minecraft.this.mcProfiler.profilingEnabled ? Minecraft.this.mcProfiler.getNameOfLastSection() : "N/A (disabled)");
        theCrash.getCategory().setDetail("CPU", () -> OpenGlHelper.getCpu());
