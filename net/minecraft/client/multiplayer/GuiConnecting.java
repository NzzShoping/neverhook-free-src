...
public class GuiConnecting extends GuiScreen {
    ...
    public GuiConnecting(GuiScreen parent, Minecraft mcIn, ServerData serverDataIn) {
        ConnectionUtils.serverData = serverDataIn;
        this.mc = mcIn;
    ...
    private void connect(final String ip, final int port) {
        ...
        LOGGER.info("[NeverHook Network] Connecting to {}, {}", ip, port);
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet()) {
            public void run() {
                ...
                try {
                    ...
                    GuiConnecting.LOGGER.error("[NeverHook Network] Couldn't connect to server", unknownhostexception);
                    ...
                    GuiConnecting.LOGGER.error("[NeverHook Network] Couldn't connect to server", exception);
