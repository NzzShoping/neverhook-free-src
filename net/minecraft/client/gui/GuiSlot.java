...
public abstract class GuiSlot {
    ...
    public void drawScreenMultiplayer(int mouseXIn, int mouseYIn, float partialTicks) {
        if (this.visible) {
            this.mouseX = mouseXIn;
            this.mouseY = mouseYIn;
            int i = this.getScrollBarX();
            ...
            RenderUtil.drawBorderedRect(-5.0D, 0D, sr.getScaledWidth() - -6, sr.getScaledHeight(), 0.5D, (new Color(44, 44, 44, 255)).getRGB(), (new Color(33, 33, 33, 255)).getRGB(), true);
            RenderUtil.drawBorderedRect(1.0D, 1.4D, sr.getScaledWidth() - 1, sr.getScaledHeight() - 1.7, 0.5D, (new Color(17, 17, 17, 255)).getRGB(), (new Color(33, 33, 33, 255)).getRGB(), true);
            int k = this.left + this.width / 2 - this.getListWidth() / 2 + 2;
            int l = this.top + 4 - (int) this.amountScrolled;
