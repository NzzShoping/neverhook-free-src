...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
    ...
    public void initGui() {
        ...
        this.nextPage = this.addButton(new GuiButton(303, width - 100, 5, 80, 20, I18n.format("createWorld.customize.custom.next")));
        this.defaults = this.addButton(new GuiButton(304, width / 2 - 187, height - 27, 90, 20, I18n.format("createWorld.customize.custom.defaults")));
        this.randomize = this.addButton(new GuiButton(301, width / 2 - 92, height - 27, 90, 20, I18n.format("createWorld.customize.custom.randomize")));
        this.presets = this.addButton(new GuiButton(305, width / 2 + 3, height - 27, 90, 20, I18n.format("createWorld.customize.custom.presets")));
        this.done = this.addButton(new GuiButton(300, width / 2 + 98, height - 27, 90, 20, I18n.format("gui.done")));
        this.defaults.enabled = this.settingsModified;
        this.confirm = new GuiButton(306, width / 2 - 55, 160, 50, 20, I18n.format("gui.yes"));
        this.confirm.visible = false;
        this.buttonList.add(this.confirm);
        this.cancel = new GuiButton(307, width / 2 + 5, 160, 50, 20, I18n.format("gui.no"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.title, width / 2, 2, 16777215);
        this.drawCenteredString(this.fontRendererObj, this.subtitle, width / 2, 12, 16777215);
        this.drawCenteredString(this.fontRendererObj, this.pageTitle, width / 2, 22, 16777215);
