    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, @Nullable ScoreObjective scoreObjectiveIn) {
        ...
        for (int k4 = 0; k4 < l3; ++k4) {
            ...
            if (k4 < list.size()) {
                ...
                if (Main.instance.featureManager.getFeatureByClass(StreamerMode.class).getState()) {
                    if (StreamerMode.tabSpoof.getValue() && !s4.contains(mc.player.getName())) {
                        s4 = "\247aProtected";
                    }
                    if (Main.instance.featureManager.getFeatureByClass(StreamerMode.class).getState()) {
                        if (StreamerMode.nameSpoof.getValue()) {
