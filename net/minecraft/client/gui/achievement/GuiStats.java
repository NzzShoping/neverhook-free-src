...
public class GuiStats extends GuiScreen implements IProgressMeter {
    ...
    public void func_193029_f() {
        ...
        GuiButton guibutton = this.addButton(new GuiButton(2, width / 2 - 80, height - 52, 80, 20, I18n.format("stat.blocksButton")));
        GuiButton guibutton1 = this.addButton(new GuiButton(3, width / 2, height - 52, 80, 20, I18n.format("stat.itemsButton")));
        GuiButton guibutton2 = this.addButton(new GuiButton(4, width / 2 + 80, height - 52, 80, 20, I18n.format("stat.mobsButton")));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (this.doesGuiPauseGame) {
            ...
            this.drawCenteredString(this.fontRendererObj, LOADING_STRINGS[(int) (Minecraft.getSystemTime() / 150L % (long) LOADING_STRINGS.length)], width / 2, height / 2 + this.fontRendererObj.FONT_HEIGHT * 2, 16777215);
        } else {
    ...
    abstract class Stats extends GuiSlot {
        ...
        protected Stats(Minecraft p_i47550_2_) {
            super(p_i47550_2_, GuiScreen.width, GuiScreen.height, 32, GuiScreen.height - 64, 20);
    ...
    class StatsGeneral extends GuiSlot {
        public StatsGeneral(Minecraft p_i47553_2_) {
            super(p_i47553_2_, GuiScreen.width, GuiScreen.height, 32, GuiScreen.height - 64, 10);
            this.func_193651_b(false);
        }
    ...
    class StatsMobsList extends GuiSlot {
        ...
        public StatsMobsList(Minecraft p_i47551_2_) {
            super(p_i47551_2_, GuiScreen.width, GuiScreen.height, 32, GuiScreen.height - 64, GuiStats.this.fontRendererObj.FONT_HEIGHT * 4);
            this.func_193651_b(false);
