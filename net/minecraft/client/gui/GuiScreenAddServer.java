...
public class GuiScreenAddServer extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.serverResourcePacks = this.addButton(new GuiButton(2, width / 2 - 100, height / 4 + 72, I18n.format("addServer.resourcePack") + ": " + this.serverData.getResourceMode().getMotd().getFormattedText()));
