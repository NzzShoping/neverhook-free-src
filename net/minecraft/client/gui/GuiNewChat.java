...
import ru.neverhook.feature.visual.ChatFeatures;
                    ...
                    if (chatline != null) {
                        ...
                        if (j1 < 200 || flag) {
                            ...
                            if (l1 > 3) {
                                ...
                                if (!(ChatFeatures.clear.getValue() && Main.instance.featureManager.getFeatureByClass(ChatFeatures.class).getState())) {
                                    drawRect(-2, j2 - 9, k + 4, j2, l1 / 2 << 24);
                                }
                                this.mc.fontRendererObj.drawStringWithShadow(s, 0.0F, (float) (j2 - 9.5) + f1, 16777215 + (l1 << 24));
