...
public class GuiEditCommandBlockMinecart extends GuiScreen implements ITabCompleter {
    ...
    public void initGui() {
        ...
        this.doneButton = this.addButton(new GuiButton(0, width / 2 - 4 - 150, height / 4 + 120 + 12, 150, 20, I18n.format("gui.done")));
        this.cancelButton = this.addButton(new GuiButton(1, width / 2 + 4, height / 4 + 120 + 12, 150, 20, I18n.format("gui.cancel")));
