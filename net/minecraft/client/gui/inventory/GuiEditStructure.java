...
public class GuiEditStructure extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("tile.structureBlock.name"), width / 2, 10, 16777215);
        ...
        if (tileentitystructure$mode == TileEntityStructure.Mode.LOAD || tileentitystructure$mode == TileEntityStructure.Mode.SAVE) {
            ...
            this.drawString(this.fontRendererObj, s, width / 2 + 154 - i, 150, 10526880);
        }
        ...
        if (tileentitystructure$mode == TileEntityStructure.Mode.SAVE) {
            ...
            this.drawString(this.fontRendererObj, s2, width / 2 + 154 - k, 110, 10526880);
        ...
        if (tileentitystructure$mode == TileEntityStructure.Mode.LOAD) {
            ...
            this.drawString(this.fontRendererObj, s3, width / 2 + 154 - l, 70, 10526880);
        }
