...
public class GuiMultiplayer extends GuiScreen {
    ...
    public void createButtons() {
        this.btnEditServer = this.addButton(new GuiButton(7, width / 2 - 154, height - 28, 70, 20, I18n.format("selectServer.edit")));
        this.btnDeleteServer = this.addButton(new GuiButton(2, width / 2 - 74, height - 28, 70, 20, I18n.format("selectServer.delete")));
        this.btnSelectServer = this.addButton(new GuiButton(1, width / 2 - 154, height - 52, 100, 20, I18n.format("selectServer.select")));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.serverListSelector.drawScreenMultiplayer(mouseX, mouseY, partialTicks);
        RenderUtil.draw2DImage(new ResourceLocation("neverhook/skeet.png"), 1, 1, 958, 1, Color.white);
        mc.fontRenderer.drawCenteredString(I18n.format("multiplayer.title"), width / 2F, 14, 16777215);
        mc.fontRenderer.drawStringWithShadow("Session Name: §a" + (Main.instance.featureManager.getFeatureByClass(StreamerMode.class).getState() ? "Protected" : mc.getSession().getUsername()), 3, 7, 16777215);
        switch (ConnectionUtils.getPlatform()) {
            case 0:
                mc.fontRenderer.drawStringWithShadow("Os: §aLinux", 3, 16, -1);
                break;
            case 1:
                mc.fontRenderer.drawStringWithShadow("Os: §aSolaris", 3, 16, -1);
                break;
            case 2:
                mc.fontRenderer.drawStringWithShadow("Os: §aWindows", 3, 16, -1);
                break;
            case 3:
                mc.fontRenderer.drawStringWithShadow("Os: §aMacOs", 3, 16, -1);
                break;
        }
