...
public class GuiKeyBindingList extends GuiListExtended {
    ...
    public GuiKeyBindingList(GuiControls controls, Minecraft mcIn) {
        super(mcIn, GuiScreen.width + 45, GuiScreen.height, 63, GuiScreen.height - 32, 20);
    ...
    public class CategoryEntry implements GuiListExtended.IGuiListEntry {
        ...
        public void func_192634_a(int p_192634_1_, int p_192634_2_, int p_192634_3_, int p_192634_4_, int p_192634_5_, int p_192634_6_, int p_192634_7_, boolean p_192634_8_, float p_192634_9_) {
            GuiKeyBindingList.this.mc.fontRendererObj.drawString(this.labelText, GuiScreen.width / 2 - this.labelWidth / 2, p_192634_3_ + p_192634_5_ - GuiKeyBindingList.this.mc.fontRendererObj.FONT_HEIGHT - 1, 16777215);
        }
