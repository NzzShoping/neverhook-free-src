...
public class RenderGlobal implements IWorldEventListener, IResourceManagerReloadListener {
    ...
    public void setWorldAndLoadRenderers(@Nullable WorldClient worldClientIn) {
        if (this.theWorld != null) {
            this.theWorld.reEventMoveListener(this);
        }
    ...
    public static void drawEspBoundingBox(double minX, double minY, double minZ, double maxX, double maxY, double maxZ, float red, float green, float blue, float alpha) {
        GL11.glPushMatrix();
        ...
        switch (type) {
            ...
            case 2004:
                for (int i3 = 0; i3 < 20; ++i3) {
                    ...
                    this.theWorld.spawnParticle(EnumParticleTypes.FLAME, d26, d28, d30, 0.0D, 0.0D, 0.0D);
                }
