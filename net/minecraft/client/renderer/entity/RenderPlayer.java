    ...
    public void doRender(AbstractClientPlayer entity, double x, double y, double z, float entityYaw, float partialTicks) {
        if (!entity.isUser() || this.renderManager.renderViewEntity == entity) {
            ...
            /*if (Main.instance.featureManager.getFeatureByClass(Chams.class).getState()) {
                ...
                Color chamsColorValue = Chams.colorChams.getColorValue();
                ...
                if(!Chams.clientColor.getValue()) {
                    ...
                    GlStateManager.color(Main.getClientColor().getRed() / 255F, Main.getClientColor().getGreen() / 255F, Main.getClientColor().getBlue() / 255F, 0.5F);
                }
