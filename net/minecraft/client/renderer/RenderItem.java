...
import ru.neverhook.feature.visual.EnchantEffect;
...
public class RenderItem implements IResourceManagerReloadListener {
    ...
    //    public int currentColor = new Color((float) EnchantEffect.red.getValDouble(), (float) EnchantEffect.green.getValDouble(), (float) EnchantEffect.blue.getValDouble()).getRGB();
    ...
    private void renderEffect(IBakedModel p_191966_1_) {
        EnchantEffect enchantEffect = (EnchantEffect) Main.instance.featureManager.getFeatureByClass(EnchantEffect.class);
        if (!Config.isCustomItems() || CustomItems.isUseGlint()) {
            if (!Config.isShaders() || !Shaders.isShadowPass) {
                ...
                //public int currentColor = new Color(enchantEffect.red.getValInt(),enchantEffect.green.getValInt(),enchantEffect.blue.getValInt()).getRGB();
                String mode = Main.instance.setmgr.getSettingByName("Enchant color").getValString();
                if (Main.instance.featureManager.getFeatureByClass(EnchantEffect.class).getState()) {
                    if (mode.equalsIgnoreCase("Rgb")) {
                        func_191965_a(p_191966_1_, Color.getHSBColor(EnchantEffect.hue / 255.0f, 1f, 1f).getRGB());
                    }
                    if (mode.equalsIgnoreCase("Custom"))
                        func_191965_a(p_191966_1_, Color.WHITE.getRGB());
                }
