...
import ru.neverhook.event.impl.EventJumping;
import ru.neverhook.feature.movement.NoJumpDelay;
...
public abstract class EntityLivingBase extends Entity {
    ...
    public final void setArrowCountInEntity(int count) {
        if (Main.instance.featureManager.getFeatureByClass(NoRender.class).getState() && NoRender.arrow.getValue()) {
        } else {
    ...
    private int getArmSwingAnimationEnd() {
        if (Main.instance.featureManager.getFeatureByClass(Animations.class).getState()) {
            int speed = Main.instance.setmgr.getSettingByName("Swing Speed").getValInt();
    ...
    protected void jump() {
        ...
        EventJumping eventJumping = new EventJumping(rotationYaw);
    ...
    public void func_191986_a(float p_191986_1_, float p_191986_2_, float p_191986_3_) {
        if (this.isServerWorld() || this.canPassengerSteer()) {
            if (!this.isInWater() || Main.instance.featureManager.getFeatureByClass(FreeCam.class).getState() || this instanceof EntityPlayer && ((EntityPlayer) this).capabilities.isFlying) {
    ...
    public void onLivingUpdate() {
        ...
        if (this.isJumping) {
            if (this.isInWater()) {
                ...
                this.jump();
                this.jumpTicks = Main.instance.featureManager.getFeatureByClass(NoJumpDelay.class).getState() ? 0 : 10;
            }
        } else {
            this.jumpTicks = 0;
        }
