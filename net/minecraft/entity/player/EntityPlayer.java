...
import ru.neverhook.feature.combat.KeepSprint;
...
public abstract class EntityPlayer extends EntityLivingBase {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag5) {
                        if (i > 0) {
                            ...
                            if (Main.instance.featureManager.getFeatureByClass(KeepSprint.class).getState()) {
                                this.motionX *= 1D;
                                this.motionZ *= 1D;
    ...
    public boolean isPushedByWater() {
        return !this.capabilities.isFlying && !(Main.instance.featureManager.getFeatureByClass(AntiPush.class).getState() && AntiPush.water.getValue());
    }
