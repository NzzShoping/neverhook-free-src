...
import ru.neverhook.event.impl.EventSafeWalk;
import ru.neverhook.event.impl.EventStep;
import ru.neverhook.event.impl.EventStrafe;
import ru.neverhook.feature.combat.HitBox;
import ru.neverhook.feature.player.AntiPush;
import ru.neverhook.feature.world.SafeWalk;
...
public abstract class Entity implements ICommandSender {
    ...
    public void setPosition(double x, double y, double z) {
        ...
        if (this instanceof EntityPlayer) {
            f = (this.width + HitBox.hitboxExpand(this)) / 2F;
            f1 = this.height + HitBox.hitboxExpand(this) / 2F;
        } else {
            f = (this.width) / 2.0F;
            f1 = this.height;
    ...
    public void moveEntity(MoverType x, double p_70091_2_, double p_70091_4_, double p_70091_6_) {
        ...
        EventManager.call(insideBlock);
        if (insideBlock.isCancelled() || noClip) {
            ...
            if (((x == MoverType.SELF || x == MoverType.PLAYER) && this.onGround && this.isSneaking() && this instanceof EntityPlayer) || (safeEvent.isCancelled() && this instanceof EntityPlayer) || (Main.instance.featureManager.getFeatureByClass(SafeWalk.class).getState() && Minecraft.getMinecraft().player.onGround)) {
    ...
    public void moveFlying(float p_191958_1_, float p_191958_2_, float p_191958_3_, float p_191958_4_) {
        ...
        float yaw = this instanceof EntityPlayerSP ? eventStrafe.getYaw() : this.rotationYaw;
    ...
    public void applyEntityCollision(Entity entityIn) {
        if (Main.instance.featureManager.getFeatureByClass(AntiPush.class).getState() && AntiPush.players.getValue())
            return;
