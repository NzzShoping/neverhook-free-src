...
public class Block {
    ...
    public boolean isFullCube(IBlockState state) {
        ...
        return !insideBlock.isCancelled();
    }
    ...
    public boolean canCollideCheck(IBlockState state, boolean hitIfLiquid) {
        Block block = state.getBlock();
        if ((Block.getIdFromBlock(block) == 58 || Block.getIdFromBlock(block) == 63 || Block.getIdFromBlock(block) == 193 || Block.getIdFromBlock(block) == 194 || Block.getIdFromBlock(block) == 195 || Block.getIdFromBlock(block) == 196 || Block.getIdFromBlock(block) == 197 || Block.getIdFromBlock(block) == 154 || Block.getIdFromBlock(block) == 61 || Block.getIdFromBlock(block) == 23 || Block.getIdFromBlock(block) == 145 || Block.getIdFromBlock(block) == 158 || Block.getIdFromBlock(block) == 69) && (Main.instance.featureManager.getFeatureByClass(NoInteract.class).getState())) {
            return false;
        }
    ...
    public boolean isCollidable() {
        return !(KillAura.wellmore.getValue() && KillAura.target != null && Main.instance.featureManager.getFeatureByClass(KillAura.class).getState());
    }
